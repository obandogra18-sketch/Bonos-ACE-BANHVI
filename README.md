...
<head>
    ...
    <!-- Application Structure Plan: Se ha diseñado una aplicación de panel de control (dashboard) con navegación por pestañas. Se añade una nueva pestaña "Líneas de Tiempo (Gantt)" para visualizar la cronología de casos específicos, complementando las vistas agregadas (Sankey) y comparativas (Infografía). -->
    <!-- Visualization & Content Choices: 
        ...
        - Comparativa de Flujos: (Meta: Comparar) Infografía HTML/CSS.
        - Línea de Tiempo de Casos (Gantt): (Meta: Explorar/Cambio) Se añade un gráfico de Gantt interactivo (Plotly.js) para mostrar la secuencia y duración de los estados a lo largo del tiempo para casos seleccionados.
